...
class KDCalendarAppearStyle: NSObject {
    // head-data
    /**
    ...
    override init() {
        ...
        self.weekDateDays = ["SUN","MON","TUE","WED","THU","FRI","SAT"]
        self.headerViewDateFont = UIFont.systemFont(ofSize: 12)
        self.headerViewWeekFont = UIFont.systemFont(ofSize: 12)
        self.headerViewWeekColor = UIColor(colorString: "0x4F505F")
        self.headerViewDateColor = UIColor(colorString: "0x4F505F")
        
        self.itemHeight = 0;
        self.dateTittleFont = UIFont.systemFont(ofSize: 14)
        self.dateDescFont = UIFont.systemFont(ofSize: 14)
        self.dateTittleSelectColor = UIColor(colorString: "0x000000")
        self.dateTittleUnselectColor = UIColor(colorString: "0x000000")
        self.dateDescSelectColor = UIColor.blue
        self.dateDescUnselectColor = UIColor.purple
        self.dateBackUnselectColor = UIColor.white
        self.dateBackSelectColor = UIColor(colorString: "0xEEEEEE") 
