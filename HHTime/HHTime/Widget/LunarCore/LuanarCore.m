 ...
 *  @return 农历年月日
 */
NSMutableDictionary *hh_solarToLunar(int _year, int _month, int _day) {
...
void hh_solarToLunarWithCalendarData(int _year, int _month, int _day, HHCalendarDataBlock calendarDataBlock) {
    
    NSMutableDictionary *inputDate = formatDate(_year, _month, _day);
    
    if (inputDate[@"error"]) {
        calendarDataBlock(inputDate);
    }
...
NSMutableDictionary *hh_calendar(int _year, int _month) {
    ...
    for (int i=0; i<monthData.count; ++i) {
        ...
        NSMutableDictionary *lunarData = hh_solarToLunar([cData[@"year"] intValue], [cData[@"month"] intValue], [cData[@"day"] intValue]);
...
*  @return 公历年月日
*/
NSMutableDictionary *hh_lunarToSolar(int _year, int _month, int _day) {
